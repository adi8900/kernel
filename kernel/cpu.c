...
static int do_cpu_down(unsigned int cpu, enum cpuhp_state target)
{
	...
	/* One performance CPU and one low power CPU must remain online */
...
#else
const struct cpumask *const cpu_lp_mask = __cpu_possible_mask;
#endif
...
#else
const struct cpumask *const cpu_perf_mask = __cpu_possible_mask;
#endif
